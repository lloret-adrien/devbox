<template>
  <div class="searchbar">
    <label for="search" style="display: none;">Search text</label>
    ...
    <input type="search" name="search" placeholder="Rechercher dans mes ressources" required=""
      minlength="2" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="true" @input="search($event.target.value)">
